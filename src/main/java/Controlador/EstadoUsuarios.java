...
public class EstadoUsuarios extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            lista = daoPr.listarActivoUsuarios(id);
            request.setAttribute("Prestamo", lista);
            //3. RequestDispacher
            RequestDispatcher rd = request.getRequestDispatcher("2.2-EstadoUsuariosU.jsp");
