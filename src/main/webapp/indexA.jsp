            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="Imagenes/img4.jpg" alt="img4" style="width:100%;">
                    </div>

                    <div class="item">
                        <img src="Imagenes/img3.jpg" alt="img3" style="width:100%;">
                    </div>

                    <div class="item">
                        <img src="Imagenes/img2.jpg" alt="img2" style="width:100%;">
                    </div>
                    <div class="item">
                        <img src="Imagenes/img1.jpg" alt="img2" style="width:100%;">
                    </div>
                </div>
