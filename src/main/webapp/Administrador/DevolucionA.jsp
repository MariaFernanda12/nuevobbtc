    ...
    <body>
        ...
        <div class="col-sm-10" id="content">
            ...
            <form method="POST" action="Devolucion">
                ...
                <input name="etiqueta"  placeholder="Etiqueta del libro o elemento...">
                <br>
                <br>
                <br>
                <p class="letra">Identificación Solicitante:</p>              
                <input name="id"  placeholder="Número de identificación del usuario...">
                <br>
                <br>
                <br>
                <p class="letra">Cantidad que devuelve:</p>              
                <input name="id"  placeholder="Cantidad de elementos devueltos...">                
